...
<div class="col-md-7" >
  ...
  <div class="form-group">
    <label class="control-label col-sm-3" for="url">Video:</label>
    <div class="col-sm-9">
       <input type="text" class="form-control" value="{{ $video->duration }}" readonly id="txtDuration" hidden="true" required="true" name="txtDuration"  placeholder="Duration">
      <input type="url" class="form-control"  value="{{ $video->url }}" readonly  required="true" name="txtUrl" id="txtUrl" placeholder="Đưòng dẫn local video">
      <input type="url" class="form-control"  value="{{ $video->url_drive }}" readonly  required="true" name="txtUrlDrive" id="txtUrlDrive" placeholder="Đưòng dẫn drive video">
...
<span id="status"></span>
    ...
    <div class="col-sm-9">
    <img src="{{asset('upload/images')}}/{{$video->image}}" width="120px" height="120px" alt="">
 ...
 <input type="file" name="fileImage">
    ...
    <div class="col-sm-9">
        ...
        <textarea name="txtDescription" id="description" class="form-control" rows="3" >{{ $video->description }}
          ...
          <div class="form-group">
      <label for="sltStatus" class="col-sm-3 control-label">Status:</label>
      <div class="col-sm-9">
        <select name="sltStatus" class="form-control"  id="sltStatus">
          ...
          <option value="stop" <?php if($video->status=="stop") echo "selected" ?> >Stop</option>
        </select>
      </div>
