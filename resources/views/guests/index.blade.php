    ...
    <body ng-app="my-app">
	  ...
	  <div class="wrapper">
	    ...
	    <div class="navbar-header">
	      ...
	      <a class="navbar-brand" href="http://video.hqapps.net/"><img src="http://hqapps.net/public/images/logo.png"></a>
	    </div>
            ...
            <div id="main" ng-controller="VideoController">
                <ul id="quizzList" data-ng-init="getListVideo('<?php echo (isset($cate->id)) ? $cate->id : ""; ?>')">
                    <li class="quizz quizzv2" ng-repeat="video in data" >
                        <div class="cover">
                            <a  ng-href="{{url('video')}}/{%video.slug%}.{%video.id%}.html" title="{% video.title %}">
                        ...
                        <div class="infos">
                            ...
                            <div class="title"><a href="{{url('video')}}/{%video.slug%}.{%video.id%}.html"">{% video.title | cut:true:50:' ...' %}</a></div>
